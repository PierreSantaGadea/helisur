...
fun EmpleadoEntity.toDomain() = Empleado(
     id_cloud, codigoArea, numeroDocumento, nombre, apellidoPaterno, apellidoMaterno, nombreCompleto, email, estado, cargo, fechaIngreso, licencia, sync, fechaRegistro, fechaModificacion,codigoUsuario,codigoTipoAeronave
)
...
fun ObtieneEmpleadosDataTableCloudResponse.toDomain() = Empleado(
    ...
    cargo = cargo, fechaIngreso = fechaIngreso, licencia = licencia, sync = true, fechaRegistro = fechaRegistro, fechaModificacion = fechaModificacion,codigoUsuario = codigoUsuario, codigoTipoAeronave = codigoTipoAeronave
)
