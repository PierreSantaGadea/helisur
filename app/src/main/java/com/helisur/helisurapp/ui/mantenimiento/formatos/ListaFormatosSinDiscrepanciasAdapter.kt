...
class ListaFormatosSinDiscrepanciasAdapter (private val mList: ArrayList<FormatoRegistro>) :
    RecyclerView.Adapter<ListaFormatosSinDiscrepanciasAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val vieww =
            LayoutInflater.from(parent.context).inflate(R.layout.item_formato_sin_discre, parent, false)
