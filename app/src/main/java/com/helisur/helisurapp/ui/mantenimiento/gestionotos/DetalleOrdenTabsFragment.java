...
import com.helisur.helisurapp.ui.mantenimiento.formatos.postvuelo.PostVueloDatosAeronaveFragment;
import com.helisur.helisurapp.ui.mantenimiento.formatos.postvuelo.PostVueloResponsableFragment;
...
public class DetalleOrdenTabsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View x = inflater.inflate(R.layout.fragment_tabs_detalle_orden, null);
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0: {
                    return new DatosGeneralesOrdenTrabajoFragment();
                }
                case 1: {
                    return new InstruccionTrabajoOrdenTrabajoFragment();
                }
                case 2: {
                    return new InsumosOrdenTrabajoFragment();
                }
                case 3: {
                    return new ComponentesOrdenTrabajoFragment();
                }
                case 4: {
                    return new TareoPersonalOrdenTrabajoFragment();
                }
