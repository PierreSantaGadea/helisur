...
class PostVueloListaTareasAdapter(val ctx: Context, private val mList: ArrayList<Tarea>) :
    ...
    ): PostVueloListaTareasAdapter.MyViewHolder {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.viewItem.setOnClickListener {
            if (holder.contenedorReportajes.isVisible) {
                ...
                var listaReportajes:ArrayList<Reportaje> = PostVueloTareasFragment.getReportajesByTarea(appItem.codigoTarea!!)
