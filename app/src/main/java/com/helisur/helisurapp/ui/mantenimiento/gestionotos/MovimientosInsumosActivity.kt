...
@AndroidEntryPoint
class MovimientosInsumosActivity : BaseActivity() {

    private lateinit var binding: ActivityOrdenMovimientosInsumosBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityOrdenMovimientosInsumosBinding.inflate(layoutInflater)
