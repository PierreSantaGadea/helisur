...
public class SpinenrItemUbicacion extends ArrayAdapter<String> {

    private Context ctx;
    private String[] contentArray;
    private Integer[] imageArray;

    public SpinenrItemUbicacion(Context context, int resource, String[] objects,
                                Integer[] imageArray) {
        super(context,  R.layout.spinner_item_ubicacion, R.id.textoo, objects);
        this.ctx = context;
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent) {
        ...
        View row = inflater.inflate(R.layout.spinner_item_ubicacion, parent, false);
